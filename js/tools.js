const TOOLS_DATA = [
  ...
  },
  {
    ...
    icon: "🛡️",
    category: "engagement",
    desc: "Protégez et sécurisez les rôles de votre serveur Discord contre les abus et modifications non autorisées.",
    longDesc: "RoleGuard est un système de sécurité avancé dédié à la protection des rôles de votre serveur Discord. Il surveille en permanence les attributions, suppressions et modifications de rôles, et bloque toute action suspecte ou non autorisée. Idéal pour les grands serveurs souhaitant garder un contrôle total sur leur hiérarchie.",
    price: 4.99, period: "mois",
    badges: ["new"],
  ...
  },
  {
    ...
    longDesc: "BlacklistGuard est un système de blacklist centralisé permettant de bannir et bloquer automatiquement les membres indésirables sur votre serveur Discord. Ajoutez des utilisateurs à votre liste noire, synchronisez-la entre plusieurs serveurs et empêchez les membres bannis de revenir grâce à une détection intelligente.",
